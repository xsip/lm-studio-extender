...
interpreting code. */
  @ApiProperty({ description: `The index of the output item in the response for which the code interpreter is
interpreting code.`, type: 'number' })
  @IsNumber()
  output_index!: number;
  ...
  @ApiProperty({ description: `The type of the event. Always \`response.code_interpreter_call.interpreting\`.`, example: 'response.code_interpreter_call.interpreting' })
