...
export class ResponseContentPartAddedEventDto {
  /** The index of the content part that was added. */
  @ApiProperty({ description: `The index of the content part that was added.`, type: 'number' })
  @IsNumber()
  ...
  @ApiProperty({ description: `The content part that was added.` })
  ...
  @ApiProperty({ description: `The type of the event. Always \`response.content_part.added\`.`, example: 'response.content_part.added' })
