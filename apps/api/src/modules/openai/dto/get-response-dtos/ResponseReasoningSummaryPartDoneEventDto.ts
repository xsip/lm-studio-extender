...
export class ResponseReasoningSummaryPartDoneEventDto {
  ...
  @ApiProperty({ description: `The completed summary part.`, type: () => PartDto })
  @ValidateNested()
  @Type(() => PartDto)
  part!: PartDto;
  ...
  @ApiProperty({ description: `The type of the event. Always \`response.reasoning_summary_part.done\`.`, example: 'response.reasoning_summary_part.done' })
