...
export class ResponseWebSearchCallCompletedEventDto {
  ...
  @ApiProperty({ description: `The type of the event. Always \`response.web_search_call.completed\`.`, example: 'response.web_search_call.completed' })
  @Equals('response.web_search_call.completed')
