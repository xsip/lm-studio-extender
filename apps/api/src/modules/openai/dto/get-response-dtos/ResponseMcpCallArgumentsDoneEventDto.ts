...
export class ResponseMcpCallArgumentsDoneEventDto {
  ...
  @ApiProperty({ description: `A JSON string containing the finalized arguments for the MCP tool call.`, type: 'string' })
  @IsString()
  arguments!: string;
  ...
  @ApiProperty({ description: `The type of the event. Always 'response.mcp_call_arguments.done'.`, example: 'response.mcp_call_arguments.done' })
