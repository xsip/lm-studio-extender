...
call. */
  @ApiProperty({ description: `A JSON string containing the partial update to the arguments for the MCP tool
call.`, type: 'string' })
  @IsString()
  delta!: string;
  ...
  @ApiProperty({ description: `The type of the event. Always 'response.mcp_call_arguments.delta'.`, example: 'response.mcp_call_arguments.delta' })
