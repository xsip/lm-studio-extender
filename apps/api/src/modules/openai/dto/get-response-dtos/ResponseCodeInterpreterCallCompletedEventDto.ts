...
is completed.`, type: 'number' })
  ...
  @ApiProperty({ description: `The type of the event. Always \`response.code_interpreter_call.completed\`.`, example: 'response.code_interpreter_call.completed' })
