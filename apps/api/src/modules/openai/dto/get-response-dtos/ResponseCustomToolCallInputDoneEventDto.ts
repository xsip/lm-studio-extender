...
export class ResponseCustomToolCallInputDoneEventDto {
  ...
  @ApiProperty({ description: `The complete input data for the custom tool call.`, type: 'string' })
  @IsString()
  input!: string;
  ...
  @ApiProperty({ description: `The index of the output this event applies to.`, type: 'number' })
  @IsNumber()
  output_index!: number;
  ...
  @ApiProperty({ description: `The event type identifier.`, example: 'response.custom_tool_call_input.done' })
