...
export class ResponseFailedEventDto {
  ...
  @ApiProperty({ description: `The response that failed.`, type: () => ResponseDto })
  @ValidateNested()
  @Type(() => ResponseDto)
  ...
  @ApiProperty({ description: `The type of the event. Always \`response.failed\`.`, example: 'response.failed' })
