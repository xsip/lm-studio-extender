...
export class ResponseQueuedEventDto {
  ...
  @ApiProperty({ description: `The full response object that is queued.`, type: () => ResponseDto })
  @ValidateNested()
  @Type(() => ResponseDto)
  ...
  @ApiProperty({ description: `The type of the event. Always 'response.queued'.`, example: 'response.queued' })
