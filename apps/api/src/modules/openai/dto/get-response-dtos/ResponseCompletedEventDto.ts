...
export class ResponseCompletedEventDto {
  ...
  @ApiProperty({ description: `Properties of the completed response.`, type: () => ResponseDto })
  @ValidateNested()
  @Type(() => ResponseDto)
  ...
  @ApiProperty({ description: `The type of the event. Always \`response.completed\`.`, example: 'response.completed' })
