...
export class ResponseCreatedEventDto {
  ...
  @ApiProperty({ description: `The response that was created.`, type: () => ResponseDto })
  @ValidateNested()
  @Type(() => ResponseDto)
  ...
  @ApiProperty({ description: `The type of the event. Always \`response.created\`.`, example: 'response.created' })
