...
export class ComparisonFilterDto {
  ...
  @ApiProperty({ description: `The key to compare against the value.`, type: 'string' })
  @IsString()
  key!: string;
...
- `in`: in
- `nin`: not in */
  @ApiProperty({ description: `Specifies the comparison operator: \`eq\`, \`ne\`, \`gt\`, \`gte\`, \`lt\`, \`lte\`, \`in\`,
\`nin\`.
...
- \`lte\`: less than or equal
- \`in\`: in
- \`nin\`: not in`, enum: ['eq', 'ne', 'gt', 'gte', 'lt', 'lte', 'in', 'nin'] })
